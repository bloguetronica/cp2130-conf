...
rm -f /usr/local/share/applications/cp2130-conf.desktop
rmdir --ignore-fail-on-non-empty /usr/local/share/applications
rm -f /usr/local/share/icons/hicolor/128x128/apps/cp2130-conf.png
...
rm -f /usr/local/bin/cp2130-conf
echo Removing source code files...
rm -rf /usr/local/src/cp2130-conf
echo Done!
